...
public class MediaPageViewModel : ViewModelBase, IDisposable
{
    static MediaPageViewModel()
    {
        LoadPlayed();
    }
    ...
    private static readonly AvaloniaList<string> _played = new();
    public static readonly MediaPageViewModel self = new ();
