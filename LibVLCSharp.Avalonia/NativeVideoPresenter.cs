...
public class NativeVideoPresenter : NativeControlHost
{
    ...
    {
        ContentProperty.Changed.AddClassHandler<NativeVideoPresenter>((s, _) => s.InitializeNativeOverlay());
        IsVisibleProperty.Changed.AddClassHandler<NativeVideoPresenter>((s, _) => s.ShowNativeOverlay(s.IsVisible));
    }
    ...
    protected override void OnAttachedToVisualTree(VisualTreeAttachmentEventArgs e)
    {
        ...
        _isEffectivelyVisibleSub = this.GetVisualAncestors().OfType<IControl>()
