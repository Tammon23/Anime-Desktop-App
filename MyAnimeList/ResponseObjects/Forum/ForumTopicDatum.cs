...
public class ForumTopicDatum
{
    ...
    [DataMember(Name = "created_by")] public User.User CreatedBy { get; }

    [DataMember(Name = "number_of_posts")] public int NumberOfPosts { get; }
    ...
    [DataMember(Name = "is_locked")] public bool IsLocked { get; }
