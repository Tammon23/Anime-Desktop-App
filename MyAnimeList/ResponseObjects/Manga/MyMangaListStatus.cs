...
namespace MyAnimeList.ResponseObjects.Manga
{
    ...
    {
        public MyMangaListStatus(MangaStatusEnum status, bool isRereading, int numVolumesRead, int numChaptersRead, int score, DateTime updatedAt)
        {
            this.Status = status;
        ...
        [DataMember]
        public MangaStatusEnum Status { get; }

        [DataMember(Name="is_rereading")]
        public bool IsRereading { get; }
